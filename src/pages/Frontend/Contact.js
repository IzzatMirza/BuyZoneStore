                        ...
                        <div className='card p-4 text-center'>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className='row '>
                                    ...
                                    <div className='col-12 col-md-6  mb-2'>
                                        <input className='form-control ' onChange={handleChange} type="text" name='subject' placeholder="Order ID Don't Miss" />
                                    </div>
                                    ...
                                    <div className='col-12 col-md-6 mb-2 '>
                                        <input className='form-control ' onChange={handleChange} type="Phone" name='city' placeholder='Adress' />
                                    </div>
